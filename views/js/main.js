...
function logAverageFrame(e) {
    for (a = e.length, r = 0, n = a - 1; n > a - 11; n--) {r += e[n].duration;
    console.log("Average scripting time to generate last 10 frames: " + r / 10 + "ms");}
}

function updatePositions() {
    frame++, window.performance.mark("mark_start_frame");
    for (var e = document.body.scrollTop / 1250, a = document.querySelectorAll(".mover"), r = 0; r < a.length; r++) {
        var n = Math.sin(e + r % 5);
